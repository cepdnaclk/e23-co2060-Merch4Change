    ...
    <div className="help-page">
      <div className="help-hero">
        ...
        <div className="help-search-bar">
          <input type="text" placeholder="Search for articles, guides or FAQs..." />
      ...
      <div className="help-categories">
        <div className="help-card" onClick={() => navigate('/faq')}>
          ...
          <p>Learn the basics of using Merch4Change and creating your account.</p>
        </div>
        ...
        <div className="help-card" onClick={() => navigate('/help/contact')}>
          ...
          <p>Can't find what you need? Reach out to our dedicated support team.</p>
        </div>
      </div>
