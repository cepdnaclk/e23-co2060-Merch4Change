    ...
    <div className="sidebar">
      <div className="logo">
        <img
          src={icon}
          alt="icon"
          style={{ maxWidth: "40px", borderRadius: 10 }}
      ...
      <nav className="nav-links">
        <div
          ...
          onClick={() => {
            (setActiveItem("home"), navigate("/home"));
          }}
        >
        ...
        <div
          className={getNavItemClass("explore")}
      ...
      <div className="sidebar-bottom">
        <div
          ...
          onClick={() => {
            (setActiveItem("settings"), navigate("/settigns"));
          }}
        >
        ...
        <div
          className={getNavItemClass("team-antigravity")}
          onClick={() => setActiveItem("team-antigravity")}
        >
